...
Access: Navigate to the starting file for each example:

App 1: http://localhost/path-to-files/products.php

App 2: http://localhost/path-to-files/index_locale.php

App 3: http://localhost/path-to-files/index.php
